...
def funcao_3():
	...
	screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
	pygame.mouse.set_visible(0)
	image3 = pygame.image.load("/home/debian/Desktop/display/Slide1.JPG")
	...
	image33 = pygame.image.load("/home/debian/Desktop/display/Slide2.JPG")
	image33 = pygame.transform.scale(image33, (screen.get_size()[0], screen.get_size()[1]))
	back33 = pygame.Surface(screen.get_size())
	back33 = back33.convert()
	back33.blit(image33,(0,0))
	screen.blit(back33,(0,0))
	while GPIO.input("P8_11"):
	  screen.blit(back3,(0,0))
	  pygame.display.flip()
	  screen.blit(back33,(0,0))
