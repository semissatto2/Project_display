...
def funcao_1():
	...
	image1 = pygame.image.load("/home/debian/Desktop/shared/beamon.jpg")
...
def funcao_2():
	...
	screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
	pygame.mouse.set_visible(0)
	image2 = pygame.image.load("/home/debian/Desktop/shared/beamoff.jpg")
...
def funcao_3():
	...
	screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
	pygame.mouse.set_visible(0)
	image3 = pygame.image.load("/home/debian/Desktop/shared/imminent.jpg")
...
def funcao_4():
	...
	screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
	pygame.mouse.set_visible(0)
	image4 = pygame.image.load("/home/debian/Desktop/shared/falha.jpg")
...
def funcao_5():
        ...
        screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
        pygame.mouse.set_visible(0)
        image4 = pygame.image.load("/home/debian/Desktop/shared/off.jpg")
        image4 = pygame.transform.scale(image4, (screen.get_size()[0], screen.get_size()[1]))
        back4 = pygame.Surface(screen.get_size())
        back4 = back4.convert()
        back4.blit(image4,(0,0))
...
def funcao_6():
        ...
        screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
        pygame.mouse.set_visible(0)
        image4 = pygame.image.load("/home/debian/Desktop/shared/5.jpg")
        image4 = pygame.transform.scale(image4, (screen.get_size()[0], screen.get_size()[1]))
        back4 = pygame.Surface(screen.get_size())
        back4 = back4.convert()
        back4.blit(image4,(0,0))
...
def funcao_7():
        ...
        screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
        pygame.mouse.set_visible(0)
        image4 = pygame.image.load("/home/debian/Desktop/shared/6.jpg")
        image4 = pygame.transform.scale(image4, (screen.get_size()[0], screen.get_size()[1]))
        back4 = pygame.Surface(screen.get_size())
        back4 = back4.convert()
        back4.blit(image4,(0,0))
...
def funcao_8():
        ...
        screen = pygame.display.set_mode((0,0),pygame.FULLSCREEN)
        pygame.mouse.set_visible(0)
        image4 = pygame.image.load("/home/debian/Desktop/shared/7.jpg")
        image4 = pygame.transform.scale(image4, (screen.get_size()[0], screen.get_size()[1]))
        back4 = pygame.Surface(screen.get_size())
        back4 = back4.convert()
        back4.blit(image4,(0,0))
